...
; Downstream divergence: the GFX13 checks name the src0 copies rather than
; forbidding v_mov_b32_e32 outright. Upstream also copies src1 into v6, but
; VOPD-packs it into a v_dual_mov_b32; downstream leaves it unpaired in two of
; the four kernels, and costs one extra VGPR.
...
; GFX13-NOT: v_mov_b32_e32 v0, v2
; GFX13-NOT: v_mov_b32_e32 v1, v3
