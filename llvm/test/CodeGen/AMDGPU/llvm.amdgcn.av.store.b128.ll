...
; GFX1310-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1310-SDAG-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v3, s3
; GFX1310-SDAG-NEXT:    v_mov_b32_e32 v2, s2
; GFX1310-SDAG-NEXT:    s_wait_dscnt 0x0
; GFX1310-SDAG-NEXT:    v_readfirstlane_b32 s4, v0
; GFX1310-SDAG-NEXT:    v_readfirstlane_b32 s5, v1
; GFX1310-SDAG-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX1310-SDAG-NEXT:    global_store_b128 v4, v[0:3], s[4:5]
...
; GFX1310-ISEL-NEXT:    s_load_b32 s6, s[4:5], 0x24 nv
; GFX1310-ISEL-NEXT:    ds_load_b64 v[0:1], v0
; GFX1310-ISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1310-ISEL-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_mov_b32 v3, s3
; GFX1310-ISEL-NEXT:    v_mov_b32_e32 v4, s6
; GFX1310-ISEL-NEXT:    s_wait_dscnt 0x0
; GFX1310-ISEL-NEXT:    v_readfirstlane_b32 s4, v0
; GFX1310-ISEL-NEXT:    v_readfirstlane_b32 s5, v1
; GFX1310-ISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX1310-ISEL-NEXT:    global_store_b128 v4, v[0:3], s[4:5]
...
; GFX1310-SDAG-NEXT:    v_readfirstlane_b32 s5, v1
; GFX1310-SDAG-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX1310-SDAG-NEXT:    global_store_b128 v4, v[0:3], s[4:5] offset:-120 scope:SCOPE_SE
; GFX1310-SDAG-NEXT:    s_endpgm
;
...
; GFX1310-ISEL-NEXT:    v_readfirstlane_b32 s5, v1
; GFX1310-ISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX1310-ISEL-NEXT:    global_store_b128 v4, v[0:3], s[4:5] offset:-120 scope:SCOPE_SE
; GFX1310-ISEL-NEXT:    s_endpgm
  %sbase = load ptr addrspace(1), ptr addrspace(3) @ptr.in.lds
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr addrspace(1) %sbase, i64 %zext.offset
